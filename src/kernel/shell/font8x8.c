...
uint8_t font8x8_basic[128][8] = {
    ...
    [0x32] = { 0x78, 0xCC, 0x0C, 0x38, 0x60, 0xC0, 0xFC, 0x00 }, // 2
    ...
    [0x52] = { 0xFC, 0x66, 0x66, 0x7C, 0x6C, 0x66, 0xC6, 0x00 }, // R
    ...
    [0x57] = { 0xC6, 0xC6, 0xD6, 0xD6, 0xFE, 0xEE, 0xC6, 0x00 }, // W
    ...
    [0x65] = { 0x00, 0x00, 0x7C, 0xC6, 0xFE, 0x60, 0x3C, 0x00 }, // e
    [0x66] = { 0x1C, 0x36, 0x30, 0x78, 0x30, 0x30, 0x78, 0x00 }, // f
    [0x67] = { 0x00, 0x00, 0x76, 0xCC, 0xCC, 0x7C, 0x0C, 0xF8 }, // g
    [0x68] = { 0xE0, 0x60, 0x6C, 0x76, 0x66, 0x66, 0xE6, 0x00 }, // h
    [0x69] = { 0x18, 0x18, 0x00, 0x18, 0x18, 0x18, 0x3C, 0x00 }, // i
    [0x6A] = { 0x06, 0x06, 0x00, 0x06, 0x06, 0x06, 0x66, 0x3C }, // j
    [0x6B] = { 0xE0, 0x60, 0x66, 0x6C, 0x78, 0x6C, 0xE6, 0x00 }, // k
    [0x6C] = { 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x1C, 0x00 }, // l
    [0x6D] = { 0x00, 0x00, 0xFE, 0xD6, 0xD6, 0xD6, 0xD6, 0x00 }, // m
    [0x6E] = { 0x00, 0x00, 0xDC, 0x66, 0x66, 0x66, 0x66, 0x00 }, // n
    [0x6F] = { 0x00, 0x00, 0x38, 0x6C, 0xC6, 0x6C, 0x38, 0x00 }, // o
    [0x70] = { 0x00, 0x00, 0x7C, 0x66, 0x66, 0x7C, 0x60, 0xF0 }, // p
    ...
    [0x79] = { 0x00, 0x00, 0xC6, 0xC6, 0xCC, 0x78, 0x30, 0xFC }, // y
